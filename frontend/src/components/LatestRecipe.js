              ...
              {/* Title */}
               ...
               {/* Item */}
                <div class="recipe-list flex flex-jc-sb flex-ai-c">
                    <LatestRecipeItem images={images[0]} avatars={avatars[0]} authorsName={authorsName[0]} foodTitles={foodTitles[0]} foodDescriptions={foodDescriptions[0]} difficulty={difficulty[0]} yeild={yeild[0]} numOfPeople={numOfPeople[0]} times={times[0]}/>
                    <LatestRecipeItem images={images[1]} avatars={avatars[1]} authorsName={authorsName[1]} foodTitles={foodTitles[1]} foodDescriptions={foodDescriptions[1]} difficulty={difficulty[1]} yeild={yeild[0]} numOfPeople={numOfPeople[1]} />
                    <LatestRecipeItem images={images[2]} avatars={avatars[2]} authorsName={authorsName[2]} foodTitles={foodTitles[2]} foodDescriptions={foodDescriptions[2]} difficulty={difficulty[2]} yeild={yeild[0]} numOfPeople={numOfPeople[2]} times={times[2]}/>
                </div>   
            </div>
        </section>
      );
